  ...
  Future<void> _fetchDoctorName() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        _firstName = (data is Map && (data['first_name'] != null || data['firstName'] != null))
            ? (data['first_name'] ?? data['firstName'])
            : (data is Map && data['firstName'] != null ? data['firstName'] : null);
        _lastName = (data is Map && (data['last_name'] != null || data['lastName'] != null))
            ? (data['last_name'] ?? data['lastName'])
            : (data is Map && data['lastName'] != null ? data['lastName'] : null);

        // If still null, try nested 'user' object
        if ((_firstName == null || _firstName!.isEmpty) && data is Map && data['user'] != null) {
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  height: 32.02,  // Height as specified
                                  margin: const EdgeInsets.only(top: 10),  // Gap as specified
                                  child: Row(
