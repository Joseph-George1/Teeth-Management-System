...
# Note: For backup, we need SYS user with SYSDBA privileges
# The .env contains DB_URL (JDBC format), DB_USERNAME, DB_PASSWORD
# For backups, we parse these into components for sqlplus
parse_db_url() {
    local jdbc_url="$1"
