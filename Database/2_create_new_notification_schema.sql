...
CREATE TABLE NOTIFICATION_DELIVERY_AUDIT (
    ...
    CREATED_AT TIMESTAMP(6) DEFAULT SYSDATE,
    CONSTRAINT FK_AUDIT_QUEUE FOREIGN KEY (NOTIFICATION_QUEUE_ID) REFERENCES NOTIFICATION_QUEUE(ID) ON DELETE CASCADE,
...
CREATE TABLE NOTIFICATION_DELIVERY_ATTEMPTS (
    ...
    CONSTRAINT FK_ATTEMPTS_QUEUE FOREIGN KEY (NOTIFICATION_QUEUE_ID) REFERENCES NOTIFICATION_QUEUE(ID) ON DELETE CASCADE,
