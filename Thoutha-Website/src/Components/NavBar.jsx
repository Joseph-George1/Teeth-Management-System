                ...
                <div className="menu-icon2">
                  ...
                  <div className="user-info-circle">
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path d="M24 23C26.2091 23 28 21.2091 28 19C28 16.7909 26.2091 15 24 15C21.7909 15 20 16.7909 20 19C20 21.2091 21.7909 23 24 23Z" stroke="#84E5F3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
