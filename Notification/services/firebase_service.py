...
class FirebaseService:
    ...
    def send_to_device(self, fcm_token: str, title: str, body: str, 
        ...
        Raises:
            firebase_admin.messaging.InvalidArgumentError: If token is invalid
            firebase_admin.messaging.UnknownError: If FCM error
        """
        try:
            ...
            return None
        except messaging.UnknownError as e:
            logger.error(f"FCM service error: {e}")
            return None
        except Exception as e:
            logger.error(f"Unexpected error sending to FCM: {e}")
            return None
